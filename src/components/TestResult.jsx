    ...
    <Card style={{ textAlign: "center" }}>
      ...
      <div style={{ marginTop: "20px" }}>
        {questions.map((q, index) => {
          const isCorrect = answers[index]?.content === q.correctAnswer?.content;
            ...
            >
              ...
              <ul style={{ textAlign: "left", paddingLeft: "20px", margin: 0 }}>
                {q.variants.map((variant, i) => {
                  ...
                  const isUserChoice =
                    answers[index]?.content === variant?.content;
                  const isCorrectChoice =
                    variant?.content === q.correctAnswer?.content;
                  ...
                  return (
                    ...
                    >
                      ...
                      {isCorrectChoice ? "(Правильный ответ)" : ""}
      ...
      >
        <Link to="/">
          <Button type="primary">Загрузить новый тест</Button>
        </Link>
        <Link to="/">
